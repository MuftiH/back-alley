...
function AfghanistanArticle(props) {
    ...
    return (
        <Article authorName="HM" articleTitle="A brief history of aghanistan"
        articleBody={text} image={afghanistan}/> 
    );
}

export default AfghanistanArticle;
