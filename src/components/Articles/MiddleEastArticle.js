...
function MiddleEastArticle(props) {
    ...
    return (
        <Article authorName="HM" articleTitle="God and Greed in the Middle East"
        articleBody={text} image={mideast}/> 
    );
}

export default MiddleEastArticle;
