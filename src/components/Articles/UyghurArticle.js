...
import uyghur from '../../assets/uyghur.jpg';

function UyghurArticle(props) {
    ...
    return (
        <Article authorName="HM" articleTitle="Uyghurs: Silenced but not unheard"
        articleBody={text} image={uyghur}/> 
    );
}
