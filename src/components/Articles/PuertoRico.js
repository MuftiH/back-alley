...
function PuertoRicoArticle(props) {
    ...
    return (
        <Article authorName="HM" articleTitle="We have forogtten the Puerto Rican people"
        articleBody={text} image={pr}/> 
    );
}

export default PuertoRicoArticle;
