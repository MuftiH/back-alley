...
function AfricaArticle(props) {
    ...
    return (
        <Article authorName="HM" articleTitle="Alkebulan: The Forgotten Continent"
        articleBody={text} image={africa}/> 
    );
}

export default AfricaArticle;
