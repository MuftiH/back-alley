...
function IsisArticle(props) {
    ...
    return (
        ...
        <Article authorName="HM" articleTitle="The Fall of the Murderous Caliphate"
        articleBody={text} image={isisImg}/> 
    );
}

export default IsisArticle;
