...
function ClimateChangeArticle(props) {
    ...
    return (
        <Article authorName="HM" articleTitle="Climate Change: A human story of arrogance and the end of the world"
        articleBody={text} image={climate}/> 
    );
}

export default ClimateChangeArticle;
